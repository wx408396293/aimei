	    ...
	    <div class="div">
			<el-row>
		    	<el-col :span="24">
		    		...
		    		<el-row >
				    	<el-col :span="24" class="table">
				    		<el-button size="small" type="danger"  style="width:140px;font-size:16px"   @click="deleteSpecial">移除专题池</el-button>
				    		<el-pagination
...
import {WORKSLIST,DELETESPECIAL} from "../../../store/worksManagement/works.js"
	export default{
		name:"worksSpecial",
		created(){
			this.WORKSLIST()
		...
		computed:{
	    	...mapState("Special",["pageSize","totalElements","WorksList"])
	    },
		methods:{
	      	...mapActions("Special",["WORKSLIST","DELETESPECIAL"]),
			...mapMutations("Special",["getPageSize"]),
		    ...
		    deleteSpecial(){
		    	this.DELETESPECIAL(this.multipleSelection.join(","))
		    }
		}
	}
</script>
