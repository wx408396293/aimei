	    ...
	    <div class="div">
			<el-row>
				<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-button size="small"  type="info" @click="dialogVisible=true">+ 作品</el-button>
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="24">
					...
					<el-row>
						<el-col :span="24">
							<el-button  type="success"size="small"  style="width:70px;font-size:16px"  @click="getselected">提交</el-button>
						</el-col>
					</el-row>
					<el-dialog
...
<script>
	import works from './addWorks/selectedsAdd_works.vue'
	import selection from "./addWorks/selectedAdd_selection.vue"
	...
	export default{
		...
		methods:{
			...
			getselected(){
    			...
    			let currentDate = parseInt(`${date.getFullYear()}${Month}${getDate}`);
    			let worksIds =[]
    			if (this.value2 === "") {
    				this.$message({
			            showClose: true,
