...
import {mapMutations,mapActions, mapState} from "vuex"
	export default{
		...
		computed:{
	    	...mapState("pendingList",["auditedapageSize","auditedaElements","auditedatList","auditedaindex"])
	    },
		methods:{
			...mapActions("pendingList",["AUDITEDARTIST"]),
			...mapMutations("pendingList",["getAuditedaindex","TOAudited"]),
			toExamine(row) {
				this.TOAudited(row)
	        },
