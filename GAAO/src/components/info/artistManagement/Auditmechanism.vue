...
import {mapMutations,mapActions, mapState} from "vuex"
	export default{
		...
		computed:{
	    	...mapState("mechanismList",["pageSize","totalElements","mechanismLIST","pageIndex"])
	    },
		methods:{
			...mapActions("mechanismList",["MECHANISMLIST"]),
			...mapMutations("mechanismList",["getPageSize","ToExamine"]),
			toExamine(row) {
				this.ToExamine(row)
	        },
	      	 //分页
