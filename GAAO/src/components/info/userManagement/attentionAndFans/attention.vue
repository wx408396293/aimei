...
import {GETFOLLOWLIST,getfollow,usersearch} from "../../../../store/userManagement/users.js"
	export default{
		name:"attention",
		data(){
			return{
		...
		computed:{
	    	...mapState("friendRelationship",["GetFollowList","GetFollowListtotal","pageSize"])
	    },
		methods:{
			...mapActions("friendRelationship",["GETFOLLOWLIST","GETFANLIST"]),
			...mapMutations("friendRelationship",["getfollow","usersearch"]),
