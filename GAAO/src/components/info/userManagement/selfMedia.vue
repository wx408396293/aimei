	    ...
	    <div class="div">
			<el-row>
		    	<el-col :span="24">
							    ...
							    <el-table-column label="操作" width="400%">
							        <template scope="scope">
								        ...
								        <el-button
								          size="small"
								          type="info" 
								          @click="handleEdit(scope.$index, scope.row)">好友关系</el-button>
								          <el-button
								          size="small"
								          type="info" 
		    		...
		    		<el-row >
				    	<el-col :span="24" class="table">
				    		<el-button type="danger" size="small"    style="width:120px;font-size:16px" @click="">解除自媒体</el-button>
				    		<el-pagination
